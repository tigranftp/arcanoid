...
public class PlayerScript : MonoBehaviour
{
    ...
    public GameObject yellowPrefabMoving; //префаб движущихся блоков
    ...
    IEnumerator BallDestroyedCoroutine()
    {
        ...
        if (GameObject.FindGameObjectsWithTag("Ball").Length == 0)
            ...
            {
                // если игрок проиграл - обновляем данные о рекордах
    ...
    void Update()
    {
        if (Input.GetButtonDown("Pause"))
            ...
            {
                Time.timeScale = 0;
                //делаем курсор видимым + канвас паузы активным.
                Cursor.visible = true;
